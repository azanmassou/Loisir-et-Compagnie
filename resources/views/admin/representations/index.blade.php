...
@section('contents')
    ...
    <div class="card">
        <div class="row">
            <div class="col-lg-6">
                <h5 class="card-header">Total Representations <span @style('color:red')>{{ $countRepresentations }}</span><a class="mx-4" href="{{ route('representations.create') }}">Ajouter</a></h5>
            </div>
                        ...
                        @foreach ($representations as $representation)
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <i class="fab fa-angular fa-lg text-danger me-3"></i> <strong><a
                                                href="{{ route('representations.show', ['representation' => $representation->id]) }}">{{ $representation->id }}</a></strong>
                                    </div>
                                </td>
                                ...
                                <td>
                                    ...
                                    {{ $representation->created_at->diffForHumans() }}
                                </td>
                                {{-- <td>
