...
@section('contents')
    ...
    <div class="card">
        <div class="row">
            <div class="col-lg-6">
                <h5 class="card-header">Total Tickets <span @style('color:red')>{{ $countTicket }}</span><a class="mx-4" href="{{ route('tickets.create') }}">Ajouter</a></h5>
            </div>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <i class="fab fa-angular fa-lg text-danger me-3"></i> <strong><a
                                                href="{{ route('tickets.show', ['ticket' => $ticket->id]) }}">{{ $ticket->Libelle }}</a></strong>
                                    </div>
                                </td>
                                <td>{{ $ticket->id }}</td>
                                {{-- <td>
