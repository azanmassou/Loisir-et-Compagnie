...
@section('title')
    Login - Page | Loisir et Compagnie
@endsection
                        ...
                        <form id="formAuthentication" class="mb-3" action="{{route("auth.login")}}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('email') is-invalid @enderror" id="email" name="email"
                                    placeholder="Enter your email or username" value="{{old("email")}}" autofocus required/>
                            ...
                            <div class="mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="on" id="remember-me" name="remember-me" {{ old('remember-me') ? 'checked' : ''}}/>
                                    <label class="form-check-label" for="remember-me"> Remember Me </label>
                                    @if ($errors->has('remember-me'))
                                    <div class="text-danger">{{ $errors->first('remember-me') }}</div>
                                @endif
                                </div>
                            </div>
                            <div class="mb-3">
