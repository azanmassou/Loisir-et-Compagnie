                                ...
                                <form action="{{route('users.edit', ['user' => $user])}}" method="post">
                                    ...
                                    <div class="form-group row align-items-center">
                                        <div class="col-md-12">
                                            ...
                                            <img class="profile-pic" src="{{asset('masterAdminer/assets/images/user/11.png')}}" alt="profile-pic">
                                            <div class="p-image">
                                    ...
                                    <div class=" row align-items-center">
                                        ...
                                        <div class="form-group col-sm-6">
                                            ...
                                            <input type="text" class="form-control" value="{{ old('name') ?? $user->name }}" id="uname" placeholder="Bni@01">
                                        </div>
                                        <div class="form-group col-sm-6">
                        ...
                        <div class="card">
                            ...
                            <form action="{{route('users.update' ,['user' => $user])}}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="Password" name="current" value="{{ old('current') }}" class="form-control @error('current') is-invalid @enderror" id="current" value="">
                                    <div id="current" class="invalid-feedback">
                                        {{ $errors->first('current') }}
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="password" class="form-label">New Password:</label>
                                    <input type="Password" value="{{ old('password') }}"  name="password" class="form-control @error('password') is-invalid @enderror" id="password" value="">
                                    <div id="password" class="invalid-feedback">
                                        {{ $errors->first('password') }}
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="passwords" class="form-label">Verify Password:</label>
                                    <input type="Password" value="{{ old('passwords') }}"  name="passwords" class="form-control @error('passwords') is-invalid @enderror" id="passwords" value="">
                            ...
                            <div class="card-body">
                                <form>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{old('email') ?? $user->email}}" class="form-control" id="email" value="Bnijone@demo.com">
                                    </div>
                                    <div class="form-group">
