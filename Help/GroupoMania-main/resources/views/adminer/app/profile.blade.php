              ...
              @include('adminer.dashboard.alerte')
                <div class="row">
                            ...
                            <div class="card-body profile-page p-0">
                                <div class="profile-header">
                                    <div class="position-relative">
                                        <img src="{{asset('masterAdminer/assets/images/page-img/profile-bg1.jpg')}}" alt="profile-bg"
                                    ...
                                    <div class="user-detail text-center mb-3">
                                        <div class="profile-img">
                                            <img src="{{asset('masterAdminer/assets/images/user/11.png')}}" alt="profile-img"
                                        ...
                                        <div class="social-links">
                                            <ul
                                                ...
                                                <li class="text-center pe-3">
                                                    <a href="#"><img src="{{asset('masterAdminer/assets/images/icon/08.png')}}"
                                                            class="img-fluid rounded" alt="facebook"></a>
                                                </li>
                                                <li class="text-center pe-3">
                                                    <a href="#"><img src="{{asset('masterAdminer/assets/images/icon/09.png')}}"
                                                            class="img-fluid rounded" alt="Twitter"></a>
                                                </li>
                                                <li class="text-center pe-3">
                                                    <a href="#"><img src="{{asset('masteradminer/assets/images/icon/10.png')}}"
                                                            class="img-fluid rounded" alt="Instagram"></a>
                                                </li>
                                                <li class="text-center pe-3">
                                                    <a href="#"><img src="{{asset('masterAdminer/assets/images/icon/11.png')}}"
                                                            class="img-fluid rounded" alt="Google plus"></a>
                                                </li>
                                                <li class="text-center pe-3">
                                                    <a href="#"><img src="{{asset('masterAdminer/assets/images/icon/12.png')}}"
                                                            class="img-fluid rounded" alt="You tube"></a>
                                                </li>
                                                <li class="text-center md-pe-3 pe-0">
                                                    <a href="#"><img src="{{asset('masterAdminer/assets/images/icon/13.png')}}"
                                        ...
                                        <div class="social-info">
                                            <ul
                                                ...
                                                <li class="text-center ps-3">
                                                    <h6>Posts</h6>
                                                    <p class="mb-0">{{$user->post->count()}}</p>
                                                </li>
                                                <li class="text-center ps-3">
                                                    <h6>Followers</h6>
                                                    <p class="mb-0">206</p>
                    ...
                    <div class="col-sm-12 text-center">
                        <img src="{{asset('masterAdminer/assets/images/page-img/page-load-loader.gif')}}" alt="loader"
                            style="height: 100px;">
                    </div>
                </div>
            </div>
